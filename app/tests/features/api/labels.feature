Feature: Labels
  ...
  Scenario: Create a new label
    When I request "PUT /v1/labels/1?user_id=3&label=cyril.leschaud@gmail.com&type_id=1&groupe_id=2"
    Then I get a "200" response
    And scope into the "data" property
    And the properties exist:
        """
  ...
  Scenario: Create a new label with wrong args
    When I request "POST /v1/labels?user_id=3&label=cyril.leschaud@gmail.com"
    Then I get a "400" response
